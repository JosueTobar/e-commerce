      ...
      <div className="container" >
        ...
        <div className="row mt-5 title-lg">
          <div className="col-lg-3">
            <i className="fa fa-credit-card mb-4" />
          </div>
          <div className="col-lg-3">
            <i className="fas funnel-dollar mb-4" />
            <i classNAme="fas fa-funnel-dollar"></i>
          </div>
          <div className="col-lg-3">
            <i className="fa fa-file-invoice-dollar mb-4" />
          </div>
          <div className="col-lg-3"></div>
        </div>
            ...
            <form className="text-center" action="#!">
              ...
              <div className="d-flex justify-content-around">
                ...
                <div className="md-form mb-3">
                  <button className="btn btn-lg btn-block" style={{ "border-radius": " 15px  15px  15px  15px", "background": "#cccccc" }} > Siguiente </button>
                </div>
              </div>
            </form>
          </div>
